...
- Azure OpenAI deployment name is hardcoded in `src/apis/openai.ts` as `AZURE_DEPLOYMENT` (`gpt-5.4`). All scoring stages (18/19/20/21) and any other Azure OpenAI call use this single constant. Update the Azure deployment and this constant in the same change.
